...
<div id="divprint">
    <table style=" border-collapse: collapse; box-shadow: 0 0 0 1px #666; color: black"
        ...
        <tr style="line-height:10px;">
            ...
            <td><span style=" font-size:14px;"> Bill No. :  </span></td>
            <td><span style=" font-size:14px;"> Lab No. :  </span></td>
        </tr>
    ...
    <table style="border-collapse: collapse;" width="99%";>
        ...
        <c:forEach items="${analysisList}" var="ana" varStatus="index">
            ...
            <tr >
                <td class="pathology-border" style="width:350px;color: black"><c:out value="${ana.test.testName}"/> </td>
